...
declare interface IApp {
   ...
   */
  onLaunch?: (options: IAppOptions) => void

  /**
   * 生命周期函数--监听小程序显示。当小程序启动，或从后台进入前台显示，会触发 onShow
   */
  onShow?: (options: IAppOptions) => void
...
declare interface IComponent {
  properties?: { [key: string]: IComponentPropertyType },
  data?: any,
  methods?: any,
  behaviors?: string[],
  created?: () => void,
  ...
  detached?: () => void,
  ready?: () => void,
  relations?: { [key: string]: IComponentRelationType },
...
declare interface IComponentEventOption {
  /**
   * 事件是否冒泡
   */
  bubbles?: boolean,
...
declare interface IComponentPropertyType {
  type: any, // String, Number, Boolean, Object, Array, null
  value?: any,
  observer?: ((newValue: any, oldValue: any) => void) | string,
}

declare interface IComponentRelationType {
  type: any,
  target?: string,
...
declare interface IPage {
  ...
  onShareAppMessage?: (options) => wx.ShareOptions
 ...
 */
declare let Page: (page: IPage) => void
...
declare namespace wx {
  ...
  export interface ShareOptions extends BaseOptions {
  ...
  export function getSetting(options: OpenGetSettingOptions): void

  export function openSetting(options: OpenGetSettingOptions): void

  export interface OpenGetSettingOptions extends BaseOptions{
    success?: (res?: {authSetting: any}) => void
  }

  export function createSelectorQuery(): CreateSelectorQueryResult

  export interface CreateSelectorQueryResult {
    in: (component: any) => CreateSelectorQueryResult
    select: (selector: string) => CreateSelectorQueryResult
    selectAll: (selector: string) => CreateSelectorQueryResult
    selectViewport: () => CreateSelectorQueryResult
    boundingClientRect: (callback: (res: Rect) => void) => CreateSelectorQueryResult
    exec: () => void
  }
