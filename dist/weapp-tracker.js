...
var Storage = /** @class */ (function () {
    ...
    Storage.prototype.getValue = function (key, defaultValue) {
        return __awaiter(this, void 0, void 0, function () {
            var innerKey, memoryCache, storageCache;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        innerKey = this.innerStorageKey(key);
                        memoryCache = this.getMemoryCache(innerKey);
                        if (memoryCache) {
                            return [2 /*return*/, memoryCache];
                        }
                        return [4 /*yield*/, this.getStorage(innerKey)];
                    case 1:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.setStorage(innerKey, value)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    TrackSender.prototype.sendTrack = function (properties) {
        ...
        return new Promise(function (resolve, reject) {
            _this.customRequest({
                url: _this.url,
                data: {
                    data: js_base64_1.Base64.encode(JSON.stringify(__assign({}, properties))),
                },
                success: function (res) {
                    resolve(res);
                },
...
Object.defineProperty(exports, "__esModule", { value: true });
var TrackSender_1 = __webpack_require__(/*! ./TrackSender */ "./src/TrackSender.ts");
var Wrapper_1 = __webpack_require__(/*! ./Wrapper */ "./src/Wrapper.ts");
...
Object.defineProperty(exports, "__esModule", { value: true });
var Tracker_1 = __webpack_require__(/*! ./Tracker */ "./src/Tracker.ts");
...
/******/ });
//# sourceMappingURL=weapp-tracker.js.map